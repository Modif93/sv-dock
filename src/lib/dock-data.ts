...
export interface TabGroup {
   ...
   */
  moreIcon?: RenderComponentConfig<Component>;
}
...
export interface TabData extends TabBase, DockDataBase {
   ...
   */
  title: string | RenderComponentConfig<Component>;
  content: RenderComponentConfig<Component> | ((tab: TabData) => RenderComponentConfig<Component>);
  closable?: boolean;
}
...
interface PanelLock {
   ...
   * if you don't need to show extra content in this case, just return null
   */
  panelExtra?: (panel: PanelData) => RenderComponentConfig<Component>;
