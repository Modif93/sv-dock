import { a4 as attributes, a5 as clsx, a6 as ensure_array_like, a7 as element, a8 as spread_props, e as escape_html, a9 as clsx$1, aa as bind_props, a3 as derived, ab as hasContext, g as getContext, a2 as setContext, ac as ATTACHMENT_KEY, ad as run, ae as props_id, af as attr_class, ag as attr, ah as attr_style, ai as stringify, aj as store_mutate, ak as store_get, al as unsubscribe_stores, am as head } from "../../chunks/index.js";
...
function isPanelData(child) {
  return "tabs" in child;
}
function isBoxData(child) {
  return "children" in child;
}
function findPanelInDockBox(boxData, panelId) {
...
function findPanelInFloatBox(floatData, panelId) {
  return floatData.children.find((panel) => panel.id === panelId) ?? null;
}
function findParentBox(box2, panelId) {
  for (let i2 = 0; i2 < box2.children.length; i2++) {
    const child = box2.children[i2];
    if (isPanelData(child) && child.id === panelId) {
      return { box: box2, index: i2 };
    }
    if (isBoxData(child)) {
...
function FlexRender($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
...
const createParseClassName$1 = (config) => {
  ...
  let parseClassName = (className) => {
    ...
    if (baseClassNameWithImportantModifier.endsWith(IMPORTANT_MODIFIER$1)) {
       ...
       */
      baseClassNameWithImportantModifier.startsWith(IMPORTANT_MODIFIER$1)
    ) {
...
const isArbitraryWeight = (value) => getIsArbitraryValue$1(value, isLabelWeight, isAny$1);
const isArbitraryFamilyName = (value) => getIsArbitraryValue$1(value, isLabelFamilyName$1, isNever$1);
...
const isArbitraryVariableWeight = (value) => getIsArbitraryVariable$1(value, isLabelWeight, true);
...
const getDefaultConfig$1 = () => {
  ...
  const scaleSizingInline = () => [isFraction$1, "screen", "full", "dvw", "lvw", "svw", "min", "max", "fit", ...scaleUnambiguousSpacing()];
  const scaleSizingBlock = () => [isFraction$1, "screen", "full", "lh", "dvh", "lvh", "svh", "min", "max", "fit", ...scaleUnambiguousSpacing()];
  ...
  return {
    ...
    classGroups: {
       ...
       */
      "font-family": [{
        font: [isArbitraryVariableFamilyName$1, isArbitraryFamilyName, themeFont]
      }],
      /**
       ...
       */
      "font-features": [{
        "font-features": [isArbitraryValue$1]
      }],
      /**
       ...
       */
      "tab-size": [{
        tab: [isInteger$1, isArbitraryVariable$1, isArbitraryValue$1]
      }],
      /**
       * Vertical Alignment
       ...
       */
      zoom: [{
        zoom: [isInteger$1, isArbitraryVariable$1, isArbitraryValue$1]
      }],
      // ---------------------
      // --- Interactivity ---
      // ---------------------
...
const dragStore = writable({ x: 0, y: 0 });
function DragDropDiv($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    let {
      ref = void 0,
      tabId,
    ...
    $$renderer2.push(`<div${attributes({ class: clsx(cn("draggable", className)), ...restProps }, "svelte-1dwd40w")}>`);
    children?.($$renderer2);
    $$renderer2.push(`<!----></div> `);
    {
      $$renderer2.push("<!--[-1-->");
...
function DockTabs($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    let {
      panelId = void 0,
      tabs = [],
    ...
    function $$render_inner($$renderer3) {
      if (Tabs) {
        ...
        Tabs($$renderer3, {
          ...
          children: ($$renderer4) => {
            $$renderer4.push(`<div class="flex h-9 shrink-0 items-center border-b border-slate-200 bg-slate-100"><div role="presentation" class="scrollbar-hide h-full min-w-0 flex-1 overflow-x-auto">`);
            if (Tabs_list) {
              $$renderer4.push("<!--[-->");
              Tabs_list($$renderer4, {
                ...
                children: ($$renderer5) => {
                  ...
                  for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
                    ...
                    DragDropDiv($$renderer5, {
                      tabId: tab.id,
                      panelId,
                      onTabDrop,
                      isParentFloating,
                      "data-sv-dock-tab-draggable": true,
                      ...
                      children: ($$renderer6) => {
                        if (Tabs_trigger) {
                          $$renderer6.push("<!--[-->");
                          Tabs_trigger($$renderer6, {
                            value: tab.id,
                            "data-sv-dock-tab-trigger": true,
                            ...
                            children: ($$renderer7) => {
                              FlexRender($$renderer7, { content: tab.title });
                            },
                            $$slots: { default: true }
                          });
                          $$renderer6.push("<!--]-->");
                        ...
                        if (tab.closable) {
                          $$renderer6.push("<!--[0-->");
                          $$renderer6.push(`<button type="button" data-sv-dock-tab-close="" class="mr-2 rounded p-0.5 text-slate-500 opacity-70 group-data-[state=active]:opacity-100 hover:bg-slate-200 hover:text-slate-900" aria-label="Close tab">`);
            ...
            $$renderer4.push(`</div></div> <div class="min-h-0 flex-1 overflow-auto bg-white"><!--[-->`);
            ...
            for (let $$index_1 = 0, $$length = each_array_1.length; $$index_1 < $$length; $$index_1++) {
              ...
              if (Tabs_content) {
                ...
                Tabs_content($$renderer4, {
                  value: tab.id,
                  class: "h-full p-3 outline-none",
                  children: ($$renderer5) => {
                    FlexRender($$renderer5, { content: tab.content });
                  },
                  $$slots: { default: true }
                });
                $$renderer4.push("<!--]-->");
    ...
    bind_props($$props, { panelId, tabs });
  });
}
function DockDrop($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    let {
      ref = null,
      children,
    ...
    dragStore.subscribe((value) => {
      if (ref) {
        ...
        isOver = rect.top < value.y && value.y < rect.bottom && rect.left < value.x && value.x < rect.right;
      }
    });
    $$renderer2.push(`<div${attr_class(clsx(cn("flex items-center justify-center border border-gray-300", half && vertical ? "h-5" : "h-10", half && horizontal ? "w-5" : "w-10", isOver ? "bg-blue-800 text-gray-200" : "bg-gray-700")))} role="presentation">`);
    children?.($$renderer2);
    $$renderer2.push(`<!----></div>`);
    bind_props($$props, { ref, isOver });
  });
}
function Dropzone($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    let $$inner_renderer;
    function $$render_inner($$renderer3) {
      $$renderer3.push(`<div class="z-10 mx-auto my-auto flex flex-col items-center justify-center gap-0.5">`);
      if (isVisible("top")) {
        $$renderer3.push("<!--[0-->");
        DockDrop($$renderer3, {
          half: true,
      ...
      $$renderer3.push(`<!--]--> <div class="flex gap-0.5">`);
      if (isVisible("west")) {
        $$renderer3.push("<!--[0-->");
        DockDrop($$renderer3, {
          half: true,
          horizontal: true,
          get isOver() {
            return isOverDrop.west;
          },
          set isOver($$value) {
            isOverDrop.west = $$value;
            $$settled = false;
          },
          children: ($$renderer4) => {
            Chevron_left($$renderer4, {});
          },
          $$slots: { default: true }
        });
      } else {
      ...
      if (isVisible("left")) {
        ...
        DockDrop($$renderer3, {
          get isOver() {
            return isOverDrop.left;
          },
          set isOver($$value) {
            isOverDrop.left = $$value;
            $$settled = false;
          },
          children: ($$renderer4) => {
            Chevron_left($$renderer4, {});
      ...
      if (isVisible("center")) {
        ...
        DockDrop($$renderer3, {
          get isOver() {
            return isOverDrop.center;
          },
          set isOver($$value) {
            isOverDrop.center = $$value;
            $$settled = false;
          }
        });
      } else {
      ...
      if (isVisible("right")) {
        ...
        DockDrop($$renderer3, {
          get isOver() {
            return isOverDrop.right;
          },
          set isOver($$value) {
            isOverDrop.right = $$value;
            $$settled = false;
          },
          children: ($$renderer4) => {
      ...
      if (isVisible("east")) {
        ...
        DockDrop($$renderer3, {
          ...
          horizontal: true,
          get isOver() {
            return isOverDrop.east;
          },
          set isOver($$value) {
            isOverDrop.east = $$value;
            $$settled = false;
          },
          children: ($$renderer4) => {
            Chevron_right($$renderer4, {});
      ...
      if (isVisible("down")) {
        ...
        DockDrop($$renderer3, {
          get isOver() {
            return isOverDrop.down;
          },
          set isOver($$value) {
            isOverDrop.down = $$value;
            $$settled = false;
          },
          children: ($$renderer4) => {
      ...
      if (isVisible("bottom")) {
        ...
        DockDrop($$renderer3, {
          ...
          vertical: true,
          get isOver() {
            return isOverDrop.bottom;
          },
          set isOver($$value) {
            isOverDrop.bottom = $$value;
            $$settled = false;
          },
          children: ($$renderer4) => {
            Chevron_down($$renderer4, {});
    ...
    $$renderer2.subsume($$inner_renderer);
    bind_props($$props, { isOverDrop });
  });
}
function DockPanel($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    let {
      panelData = void 0,
      onPanelEmpty,
    ...
    dropStore.subscribe((value) => {
      isDragging = value.tabId !== void 0 && value.fromId !== void 0 && panelData.id !== value.fromId;
    });
    dragStore.subscribe((value) => {
    ...
    let $$inner_renderer;
    function $$render_inner($$renderer3) {
      $$renderer3.push(`<div class="relative flex h-full min-h-0 min-w-0 flex-col overflow-hidden border border-slate-200 bg-white">`);
      DockTabs($$renderer3, {
        ...
        get tabs() {
          return panelData.tabs;
        },
        set tabs($$value) {
          panelData.tabs = $$value;
          $$settled = false;
        }
      });
      $$renderer3.push(`<!----> `);
      if (isDragging && isPointerInside) {
        $$renderer3.push("<!--[0-->");
        $$renderer3.push(`<div class="absolute inset-0 z-20 flex bg-sky-500/10 backdrop-blur-[1px]">`);
        Dropzone($$renderer3, {
    ...
    $$renderer2.subsume($$inner_renderer);
    bind_props($$props, { panelData });
  });
}
function DockBox_1($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    let { boxData = void 0, onTabDrop, dropzoneVisibility } = $$props;
    const isHorizontal = derived(() => boxData.mode === "horizontal");
    function childWeight(index2) {
      return boxData.children[index2]?.size ?? 1;
    }
    function childStyle(index2) {
      return `flex: ${childWeight(index2)} 1 0; min-width: 0; min-height: 0;`;
    }
    function handlePanelEmpty(index2) {
      if (isPanelData(boxData.children[index2])) {
        boxData.children.splice(index2, 1);
      }
    }
    $$renderer2.push(`<div${attr_class("sv-dock-group flex h-full w-full overflow-hidden", void 0, { "flex-row": isHorizontal(), "flex-col": !isHorizontal() })}${attr("data-direction", boxData.mode)}><!--[-->`);
    const each_array = ensure_array_like(boxData.children);
    for (let i2 = 0, $$length = each_array.length; i2 < $$length; i2++) {
      let child = each_array[i2];
      if (i2 > 0) {
        $$renderer2.push("<!--[0-->");
        $$renderer2.push(`<button type="button" aria-label="Resize dock panel" class="sv-dock-resizer shrink-0 bg-slate-200 transition-colors hover:bg-sky-400 data-[direction=horizontal]:w-1 data-[direction=horizontal]:cursor-col-resize data-[direction=vertical]:h-1 data-[direction=vertical]:cursor-row-resize"${attr("data-direction", boxData.mode)}></button>`);
      } else {
        $$renderer2.push("<!--[-1-->");
      }
      $$renderer2.push(`<!--]--> <div data-dock-child="" class="min-h-0 min-w-0 overflow-hidden"${attr_style(childStyle(i2))}>`);
      if (isPanelData(child)) {
        $$renderer2.push("<!--[0-->");
        DockPanel($$renderer2, {
          panelData: child,
          onTabDrop: (e) => onTabDrop?.(e),
          onPanelEmpty: () => handlePanelEmpty(i2),
          dropzoneVisibility
        });
      } else if (isBoxData(child)) {
        $$renderer2.push("<!--[1-->");
        DockBox_1($$renderer2, { boxData: child, onTabDrop, dropzoneVisibility });
      } else {
        $$renderer2.push("<!--[-1-->");
      }
      $$renderer2.push(`<!--]--></div>`);
...
function ResizeHandle($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    let { pos, handleClicked } = $$props;
    $$renderer2.push(`<button aria-label="handle"${attr_class(clsx(cn(handleVariant({ pos }))))}></button>`);
  });
}
function FloatPanel($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    var $$store_subs;
    let {
      id = void 0,
      tabs = [],
      box: box2 = { w: 360, h: 240, x: 100, y: 100, z: 0 },
      onTabEmpty,
      onTabDrop,
      dropzoneVisibility
    } = $$props;
    ...
    dropStore.subscribe((value) => {
      isTabDragging = value.tabId !== void 0 && value.fromId !== void 0 && id !== value.fromId;
    });
    dragStore.subscribe((value) => {
      isPointerInside = false;
    });
    function handleResizeStart(e, pos) {
      e.stopPropagation();
      e.preventDefault();
      e.clientX;
      e.clientY;
    ...
    function handlePanelDragStart(e) {
      ...
      box2.x;
      box2.y;
      store_mutate($$store_subs ??= {}, "$dropStore", dropStore, store_get($$store_subs ??= {}, "$dropStore", dropStore).fromId = id);
    }
    let $$settled = true;
    let $$inner_renderer;
    function $$render_inner($$renderer3) {
      $$renderer3.push(`<div${attr_class(clsx(cn("sv-dock-float absolute flex flex-col overflow-hidden rounded-md border border-slate-300 bg-white shadow-xl transition-opacity duration-100", isDragging ? "opacity-70" : "opacity-100")))}${attr_style(`width: ${stringify(box2.w)}px; height: ${stringify(box2.h)}px; top: ${stringify(box2.y)}px; left: ${stringify(box2.x)}px; z-index: ${stringify(box2.z ?? 1)};`)}><div class="min-h-0 flex-1">`);
      DockTabs($$renderer3, {
        onTabEmpty,
        onTabDrop: (e) => onTabDrop?.(e),
        isParentFloating: true,
      ...
      if (isTabDragging && isPointerInside) {
        $$renderer3.push("<!--[0-->");
        $$renderer3.push(`<div class="absolute inset-0 z-20 bg-sky-500/10 backdrop-blur-[1px]">`);
        Dropzone($$renderer3, {
          panelId: id,
          visibility: dropzoneVisibility,
          ondrop: (e) => onTabDrop?.(e),
      ...
      $$renderer3.push(`<!--]--></div> `);
      ResizeHandle($$renderer3, { pos: "w", handleClicked: handleResizeStart });
      $$renderer3.push(`<!----> `);
      ResizeHandle($$renderer3, { pos: "e", handleClicked: handleResizeStart });
      $$renderer3.push(`<!----> `);
      ResizeHandle($$renderer3, { pos: "n", handleClicked: handleResizeStart });
      $$renderer3.push(`<!----> `);
      ResizeHandle($$renderer3, { pos: "s", handleClicked: handleResizeStart });
      $$renderer3.push(`<!----> `);
      ResizeHandle($$renderer3, { pos: "nw", handleClicked: handleResizeStart });
      $$renderer3.push(`<!----> `);
      ResizeHandle($$renderer3, { pos: "ne", handleClicked: handleResizeStart });
      $$renderer3.push(`<!----> `);
      ResizeHandle($$renderer3, { pos: "sw", handleClicked: handleResizeStart });
      $$renderer3.push(`<!----> `);
      ResizeHandle($$renderer3, { pos: "se", handleClicked: handleResizeStart });
      $$renderer3.push(`<!----></div>`);
    }
    do {
      $$settled = true;
    ...
    bind_props($$props, { id, tabs, box: box2 });
  });
}
function FloatBox($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    let {
      floatData = void 0,
      onPanelEmpty,
    ...
    function $$render_inner($$renderer3) {
      $$renderer3.push(`<!--[-->`);
      const each_array = ensure_array_like(floatData.children);
      for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
        let child = each_array[$$index];
        FloatPanel($$renderer3, {
    ...
    $$renderer2.subsume($$inner_renderer);
    bind_props($$props, { floatData });
  });
}
function DockLayout($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    var $$store_subs;
    let { defaultLayout, layout = void 0, class: className = "" } = $$props;
    let boxData = { mode: "horizontal", children: [] };
    let floatData = { mode: "float", children: [] };
    const dropzoneVisibility = derived(() => ({
      top: boxData.mode !== "vertical",
      bottom: boxData.mode !== "vertical",
      west: boxData.mode !== "horizontal",
      east: boxData.mode !== "horizontal"
    }));
    function onPanelEmpty(id) {
      if (!id) return;
    ...
    function handleEmptyBox(box2) {
      for (let i2 = box2.children.length - 1; i2 >= 0; i2--) {
        const child = box2.children[i2];
        if (isBoxData(child) && handleEmptyBox(child)) {
          box2.children.splice(i2, 1);
        }
      }
      return box2.children.length === 0;
    }
    function handleEmptyPanelInDock(panelId) {
      const result = findParentBox(boxData, panelId);
      if (!result) return;
      result.box.children.splice(result.index, 1);
      handleEmptyBox(boxData);
    }
    function findAndRemoveTab(panelId, tabId) {
      ...
      if (panel.tabs.length === 0) {
        const isFloatingPanel = floatData.children.some((panel2) => panel2.id === panelId);
        if (isFloatingPanel) {
    ...
    function createPanel(tab, size = 1) {
      return { id: nanoid(), tabs: [tab], size };
    }
    function splitRoot(direction, tab) {
    ...
    function splitPanel(targetPanelId, direction, tab) {
    ...
    function onTabDrop(e) {
      if (store_get($$store_subs ??= {}, "$dropStore", dropStore).handled || !e.fromId || !e.tabId) return;
      const tab = findAndRemoveTab(e.fromId, e.tabId);
      if (!tab) return;
      if (e.toId && e.direction === "center") {
        findPanelById(e.toId)?.tabs.push(tab);
      } else if (e.direction === "top" || e.direction === "bottom" || e.direction === "west" || e.direction === "east") {
        splitRoot(e.direction, tab);
      } else if (e.toId && (e.direction === "up" || e.direction === "down" || e.direction === "left" || e.direction === "right")) {
        if (!splitPanel(e.toId, e.direction, tab)) {
          splitRoot(
            e.direction === "left" ? "west" : e.direction === "right" ? "east" : e.direction === "up" ? "top" : "bottom",
            tab
          );
        }
      } else {
        const { x: x2, y: y2 } = get(dragStore);
        floatData.children.push({
          id: nanoid(),
          tabs: [tab],
          box: { x: x2, y: y2, w: 360, h: 240, z: floatData.children.length + 1 }
        });
      }
      store_mutate($$store_subs ??= {}, "$dropStore", dropStore, store_get($$store_subs ??= {}, "$dropStore", dropStore).handled = true);
    }
    let $$settled = true;
    let $$inner_renderer;
    function $$render_inner($$renderer3) {
      $$renderer3.push(`<div${attr_class(`sv-dock relative h-full w-full overflow-hidden bg-slate-50 text-slate-950 ${className}`)}>`);
      DockBox_1($$renderer3, {
        onTabDrop,
  ...
  function $$render_inner($$renderer2) {
    head("1uha8ag", $$renderer2, ($$renderer3) => {
      $$renderer3.title(($$renderer4) => {
        $$renderer4.push(`<title>sv-dock — Svelte docking layout</title>`);
      });
      $$renderer3.push(`<meta name="description" content="Svelte docking layout library inspired by rc-dock, using bits-ui tabs and paneforge-style panel resizing."/>`);
    });
    $$renderer2.push(`<main class="min-h-screen bg-slate-950 text-white"><section class="mx-auto flex max-w-6xl flex-col gap-10 px-6 py-14"><div class="grid gap-8 lg:grid-cols-[1fr_420px] lg:items-center"><div class="space-y-6"><p class="w-fit rounded-full border border-sky-400/40 bg-sky-400/10 px-3 py-1 text-sm text-sky-200">Svelte 5 docking layout library</p> <div class="space-y-4"><h1 class="text-5xl font-semibold tracking-tight text-white md:text-7xl">sv-dock</h1> <p class="max-w-2xl text-lg leading-8 text-slate-300">rc-dock과 유사한 JSON 기반 docking layout을 Svelte 5로 제공합니다. 탭은 bits-ui를 사용하고,
            panel split/resize는 paneforge 구조를 참고한 내부 flex splitter로 동작합니다.</p></div> <div class="flex flex-wrap gap-3 text-sm text-slate-200"><span class="rounded-full bg-white/10 px-3 py-1">nested panels</span> <span class="rounded-full bg-white/10 px-3 py-1">draggable tabs</span> <span class="rounded-full bg-white/10 px-3 py-1">floating panels</span> <span class="rounded-full bg-white/10 px-3 py-1">Cloudflare-ready docs</span></div></div> <div class="rounded-2xl border border-white/10 bg-white/5 p-5 shadow-2xl shadow-sky-950/40"><h2 class="mb-3 text-sm font-medium uppercase tracking-[0.3em] text-sky-200">Install</h2> <pre class="overflow-x-auto rounded-xl bg-slate-900 p-4 text-sm text-slate-100"><code>pnpm add sv-dock bits-ui</code></pre> <p class="mt-3 text-sm text-slate-400">\`bits-ui\`는 탭 primitive 런타임 의존성입니다. Tailwind 없이도 동작하지만 기본 스타일은 utility class로 제공됩니다.</p></div></div> <section class="rounded-3xl border border-white/10 bg-white p-2 text-slate-950 shadow-2xl"><div class="h-[620px] overflow-hidden rounded-2xl border border-slate-200">`);
    DockLayout($$renderer2, {
      get layout() {
        return layout;
      },
      set layout($$value) {
    ...
    $$renderer2.push(`<!----></div></section> <section class="grid gap-6 lg:grid-cols-2"><article class="rounded-2xl border border-white/10 bg-white/5 p-6"><h2 class="text-2xl font-semibold">Usage</h2> <pre class="mt-4 max-h-[520px] overflow-auto rounded-xl bg-slate-900 p-4 text-sm text-slate-100"><code>&lt;script lang="ts">
  import { DockLayout, type LayoutData } from 'sv-dock';
...
&lt;DockLayout bind:layout /></code></pre></article> <article class="rounded-2xl border border-white/10 bg-white/5 p-6 text-slate-300"><h2 class="text-2xl font-semibold text-white">API shape</h2> <dl class="mt-5 space-y-4"><div><dt class="font-mono text-sky-200">DockLayout</dt> <dd>\`layout\` 또는 \`bind:layout\`을 받아 dockbox/floatbox 상태를 렌더링합니다.</dd></div> <div><dt class="font-mono text-sky-200">LayoutData.dockbox</dt> <dd>\`horizontal\`/\`vertical\` 중첩 box와 tab panel 배열로 전체 split 구조를 선언합니다.</dd></div> <div><dt class="font-mono text-sky-200">TabData</dt> <dd>\`id\`, \`title\`, \`content\`, \`closable\`을 가지며 문자열, 컴포넌트, snippet 렌더 헬퍼를 지원합니다.</dd></div> <div><dt class="font-mono text-sky-200">renderComponent / renderSnippet</dt> <dd>Svelte 컴포넌트나 snippet을 탭 title/content로 전달할 때 사용하는 helper입니다.</dd></div></dl></article></section></section></main>`);
  }
  do {
    $$settled = true;
